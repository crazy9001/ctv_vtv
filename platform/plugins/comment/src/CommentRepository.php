...
use Botble\Comment\Vote;
use Illuminate\Support\Arr;
use Illuminate\Support\Facades\DB;
use Botble\Comment\Contracts\Moderator;
use Botble\Comment\Facades\Formatter as FormatterFacade;
...
class CommentRepository implements Contracts\CommentRepository
{
    ...
    /**
     * @var \Botble\Comment\Contracts\Moderator
     */
    protected $moderator;
     ...
     *
     * @param  array $config
     * @param  \Botble\Comment\Contracts\Moderator $moderator
     * @return void
     */
     ...
     *
     * @param  array $args
     * @return \Botble\Comment\Paginator
     */
    public function get(array $args)
    {
        ...
        //dd($idOrEmail);
        $this->applyStatusScope($query, Comment::STATUS_APPROVED, null);
    ...
    {
        $query = $this->query()
            ->where(function ($que) use($args) {
                if(isset($args['content']) && !empty($args['content'])){
                    $que->where('content', FormatterFacade::parse($args['content']));
                }
            })
     ...
     *
     * @param  int $id
     * @return \Botble\Comment\Comment|null
     */
