...
class SettingInput
{
    ...
    public function __construct($type, array $data)
    {
        ...
        if (! isset($this->data['label'])) {
            $this->data['label'] = Lang::get('plugins/comment::admin.'.$this->key.'_label');
        }

        if (! isset($this->data['help'])) {
            $this->data['help'] = Lang::get('plugins/comment::admin.'.$this->key.'_help');
        }
    }
    ...
    public function render()
    {
        return new HtmlString(
            View::make('plugins/comment::admin.input-types.'.$this->type, $this->data)
        );
    }
