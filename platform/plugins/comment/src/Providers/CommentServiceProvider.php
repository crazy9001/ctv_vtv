...
use Botble\Comment\CommentPolicy;
use Botble\Comment\CommentRepository;
use Botble\Comment\Formatter;
use Botble\Comment\Moderator;
use Botble\Comment\Settings;
...
class CommentServiceProvider extends ServiceProvider
{
    ...
    protected function registerServices($app)
    {
        ...
        $app->alias('comments.settings', \Botble\Comment\Contracts\Settings::class);
        $app->alias('comments.formatter', \Botble\Comment\Contracts\Formatter::class);
        $app->alias('comments.moderator', \Botble\Comment\Contracts\Moderator::class);
        $app->alias('comments.repository', \Botble\Comment\Contracts\CommentRepository::class);
    }
