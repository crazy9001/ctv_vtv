...
<head>
    ...
    <link href="{{ ScriptVariables::mix('admin.css', 'vendor/core/plugins/comment') }}" rel="stylesheet">
    ...
    <nav class="navbar navbar-toggleable-md navbar-light bg-faded mb-4">
        <div class="container">
            ...
            <a href="/" class="navbar-brand">
                @lang('plugins/comment::admin.nav_item_home')
            </a>

            <div class="collapse navbar-collapse" id="navbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item {{ request()->route()->getName() === 'comments.dashboard' ? 'active' : '' }}">
                        <a href="{{ route('comments.dashboard') }}" class="nav-link">
                            <svg xmlns="http://www.w3.org/2000/svg" class="align-middle" width="22" height="22"
                                 viewBox="0 0 24 24">
                            ...
                            @lang('plugins/comment::admin.nav_item_dashboard')
                        </a>
                    </li>

                    @if (config('comments.settings'))
                        <li class="nav-item {{ request()->route()->getName() === 'comments.settings' ? 'active' : '' }}">
                            <a href="{{ route('comments.settings') }}" class="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" class="align-middle" width="22" height="22"
                                     viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                ...
                                @lang('plugins/comment::admin.nav_item_settings')
                            </a>
                        </li>
                    @endif
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a @click.prevent="logout" href="#" class="nav-link">
                            ...
                            @lang('plugins/comment::admin.nav_logout')
                        </a>
                    </li>
                </ul>
            </div>
...
<script src="{{ ScriptVariables::mix('admin.js', 'vendor/core/plugins/comment') }}"></script>
</body>
</html>
