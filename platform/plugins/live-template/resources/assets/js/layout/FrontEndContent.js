    ...
    return (
        ...
        <div id="carouselExampleControls" data-interval={3000} className="carousel slide" data-ride="carousel">
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img className="d-block w-100" src="/vendor/core/plugins/live-template/assets/images/slider.png" alt="First slide" />
            </div>
            <div className="carousel-item">
              <img className="d-block w-100" src="/vendor/core/plugins/live-template/assets/images/slider.png" alt="Second slide" />
            </div>
            <div className="carousel-item">
              <img className="d-block w-100" src="/vendor/core/plugins/live-template/assets/images/slider.png" alt="Third slide" />
            </div>
          </div>
        </div>
        {/* End Slider */}
        ...
        <div id="child" className="d-flex row mr-0 block-column">
          ...
          <div className="w-percent-tow col-xl-3 col-lg-4 col-md-6 col-8 row m-0">
            <div className="d-flex w-25 justify-content-center align-items-center">
              <img width={50} height={50} src="/vendor/core/plugins/live-template/assets/images/ic-cn-2.png" alt="Third slide" />
            </div>
            <div className="
              content
              w-75
          ...
          ">
            <div className="d-flex w-25 justify-content-center align-items-center">
              <img width={50} height={50} src="/vendor/core/plugins/live-template/assets/images/ic-cn-3.png" alt="Third slide" />
            </div>
            <div className="
              content
              w-75
          ...
          ">
            <div className="d-flex w-25 justify-content-center align-items-center">
              <img width={50} height={50} src="/vendor/core/plugins/live-template/assets/images/ic-cn-4.png" alt="Third slide" />
            </div>
            <div className="
              content
              w-75
        ...
        <section className="section-home">
          ...
          <div className="container">
            <div className="block-one row shadow-sm bg-white">
              ...
              ">
                <a href="#">
                  <img src="/vendor/core/plugins/live-template/assets/images/img-bg-news.png" className="img-fluid" alt="Third slide" />
                </a>
              </div>
              <div className="col-lg-6 w-100 justify-content-center align-items-center">
                <div className="news-text-title">
                  <h3>
                    Thỏa thuận hợp tác trong lĩnh vực Giáo dục đào tạo giữa Trường
                    Cao đẳng Truyền hình và Trường Đại học Đại Nam
                  </h3>
                </div>
                <div className="time-view d-flex flex-row align-items-center">
                  <i className="far fa-calendar-alt" style={{color: '#666666', width: '17px', height: '16px'}} />
                  <span className="ml-2">27/03/2021 - 15:30:17</span>
                </div>
                <div className="news-content-text">
                  <span>
                    Trường Cao đẳng Truyền hình đã trải qua 65 năm xây dựng và
                    phát triển, Nhà trường có bề dày trong công tác đào tạo. Với
                    mục tiêu phát triển của Trường Cao đẳng Truyền hình là cơ sở
                    đào tạo chất lượng cao, lấy phương châm đào tạo nghề gắn với
                    doanh nghiệp.
                  </span>
                </div>
              </div>
                ...
                ">
                  <div className="bg-img h-100">
                    <div className="d-flex align-items-center justify-content-center">
                      <a href="#">
                        <img src="/vendor/core/plugins/live-template/assets/images/junior-high-school-girl-homework.png" className="img-fluid" />
                      </a>
                    </div>
                    ...
                    <div className="content-new-item">
                      Phóng sự ảnh: Nhiệt huyết tuổi trẻ của sinh viên VTV College
                      nhân Phóng sự ảnh: Nhiệt huyết tuổi trẻ của sinh viên VTV
                      College nhânPhóng sự ảnh: Nhiệt huyết tuổi trẻ của sinh viên
                      VTV College nhân
                    </div>
                  </div>
                </div>
                ...
                <div className="carousel-item active">
                  <div className="container">
                    <div className="row">
                      <div className="col-4">
                        <a href="#">
                          <img src="/vendor/core/plugins/live-template/assets/images/img-daotao1.png" className="img-fluid" />
                        </a>
                      ...
                      <div className="col-4">
                        <img src="/vendor/core/plugins/live-template/assets/images/img-daotao2.png" className="img-fluid" />
                        <div className="content-daotao">
                          Chắp cánh ước mơ cho bạn làm truyền thông, truyền hình
                        </div>
                      </div>
                      <div className="col-4">
                        <img src="/vendor/core/plugins/live-template/assets/images/img-daotao3.png" className="img-fluid" />
                        <div className="content-daotao">
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="bg-tuyesinh d-flex flex-column">
                  <a href="#">
                    <img className="img-fluid" src="/vendor/core/plugins/live-template/assets/images/bg-tuyensinh1.png" alt="Third slide" />
                  </a>
                  <div className="time-item-ps d-flex flex-row align-items-center">
                    <i className="far fa-calendar-alt" style={{color: '#666666', width: '17px', height: '16px'}} />
                    <span className="ml-2">27/03/2021 - 15:30:17</span>
              ...
              <div className="col-lg-6">
                <div className="tuyensinh-item row">
                  ...
                  ">
                    <a href="#">
                      <img src="./vendor/core/plugins/live-template/assets/images/img-item-tuyensinh1.png" className="img-fluid" />
                    </a>
                  </div>
        ...
        <section className="section-home">
          <div className="container">
            ...
            <div className="tab-sinhvien">
              {/* Tab links */}
              <div className="tab">
                <div id="defaultOpen" className="tablinks" onclick="openCity(event, 'TIN_TUC')">
                  TIN TỨC
                </div>
                <div className="tablinks" onclick="openCity(event, 'TAC_PHAM_SINH_VIEN')">
                  TÁC PHẨM SINH VIÊN
                </div>
              </div>
              {/* Tab content */}
                  ...
                  <div className="row">
                    <div className="col-xl-3 col-lg-4 col-md-6">
                      <div className="bg-sv-tintuc d-flex flex-column">
                        <a href="#">
                          <img src="/vendor/core/plugins/live-template/assets/images/hanh-trang-nhap-hoc-cho-tan-sinh-vien-1.png" className="img-fluid" />
                        </a>
                        <div className="time-item-ps d-flex flex-row align-items-center">
                          <i className="far fa-calendar-alt" style={{color: '#666666', width: '17px', height: '16px'}} />
                          <span className="ml-2">27/03/2021 - 15:30:17</span>
