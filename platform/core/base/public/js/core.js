...
var _mediumEditor = __webpack_require__(/*! medium-editor */ "./node_modules/medium-editor/dist/js/medium-editor.js");
          ...
          onSelectFiles: function onSelectFiles(files, $el) {
            switch ($el.data('action')) {
              ...
              case 'media-insert-mediumeditor':
                ...
                _mediumEditor.util.insertHTMLCommand(window.document, html_content); //_this.initPlayer();
